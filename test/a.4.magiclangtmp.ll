...
entry:
  ...
  %x1 = bitcast float* %x to i8*, !taffo.info !17, !taffo.initweight !18, !taffo.target !12
  %y2 = bitcast float* %y to i8*, !taffo.info !19, !taffo.initweight !18, !taffo.target !16
  %call = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), float* %x), !taffo.info !17, !taffo.initweight !18, !taffo.target !12, !taffo.constinfo !20
  %call3 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), float* %y), !taffo.info !19, !taffo.initweight !18, !taffo.target !16, !taffo.constinfo !20
  ...
  store float %add, float* %2, align 4, !taffo.info !28, !taffo.initweight !29, !taffo.target !12
  ...
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), double %conv), !taffo.constinfo !20
  ret i32 0, !taffo.info !30
}
