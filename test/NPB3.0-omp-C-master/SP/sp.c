...
c-------------------------------------------------------------------*/
  ...
  if (fp != NULL) {
      ...
      grid_points[0] = vtmp[0];
      grid_points[1] = vtmp[1];
      grid_points[2] = vtmp[2];
      fclose(fp);
  } else {
...
static void add(void) __attribute__((always_inline)) {
  int i, j, k, m;
...
c-------------------------------------------------------------------*/
  ...
  int i, j, k, m, d;
  double FIXP_ANN xi, eta, zeta, u_exact[5], add;
...
static void exact_rhs(void) __attribute__((always_inline)) {
...
c-------------------------------------------------------------------*/
  ...
  double FIXP_ANN dtemp[5], xi, eta, zeta, dtpp;
...
static void exact_solution(double FIXP_ANN xi, double FIXP_ANN eta, double FIXP_ANN zeta,
                           double FIXP_ANN dtemp[5]) __attribute__((always_inline)) {
...
c-------------------------------------------------------------------*/
  ...
  double FIXP_ANN xi, eta, zeta, Pface[2][3][5], Pxi, Peta, Pzeta, temp[5];
...
c-------------------------------------------------------------------*/
  ...
  int i, j, k;
  double FIXP_ANN r1, r2, r3, r4, r5, t1, t2;
...
--------------------------------------------------------------------*/
  ...
  int i, j, k, m;
  double FIXP_ANN aux, rho_inv, uijk, up1, um1, vijk, vp1, vm1,
    wijk, wp1, wm1;
...
--------------------------------------------------------------------*/
  ...
  int i, j, k;
  double FIXP_ANN t1, t2, t3, ac, ru1, uu, vv, ww, r1, r2, r3, 
    r4, r5, ac2inv;
...
c-------------------------------------------------------------------*/
  ...
  int i, j, k;
  double FIXP_ANN t1, t2, t3, ac, xvel, yvel, zvel, r1, r2, r3, 
