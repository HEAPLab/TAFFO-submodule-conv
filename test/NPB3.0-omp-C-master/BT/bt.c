...
static void compute_rhs(void) {
  ...
  int i, j, k, m;
  double FIXP_ANN rho_inv, uijk, up1, um1, vijk, vp1, vm1, wijk, wp1, wm1;
...
static void matvec_sub(double FIXP_ANN ablock[5][5], double FIXP_ANN avec[5], double FIXP_ANN bvec[5]) __attribute__((always_inline)) {
...
static void matmul_sub(double FIXP_ANN ablock[5][5], double FIXP_ANN bblock[5][5],
		       double FIXP_ANN cblock[5][5]) __attribute__((always_inline)) {
...
static void binvcrhs(double FIXP_ANN lhs[5][5], double FIXP_ANN c[5][5], double FIXP_ANN r[5]) __attribute__((always_inline)) {

/*--------------------------------------------------------------------
--------------------------------------------------------------------*/

  double FIXP_ANN pivot, coeff;
...
static void binvrhs( double FIXP_ANN lhs[5][5], double FIXP_ANN r[5] ) __attribute__((always_inline)) {
