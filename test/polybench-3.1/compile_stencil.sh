...
echo adi
./magiclang.sh 'stencils/adi/adi.c' '-O3' '-I utilities -I stencils/adi -lm -DPOLYBENCH_TIME -DSMALL_DATASET -DPOLYBENCH_DUMP_ARRAYS -DPOLYBENCH_STACK_ARRAYS' '' 'adi_out' 'utilities/polybench.c' '-fixpfracbitsamt=24 -fixpbitsamt=32' 
...
echo fdtd-apml
./magiclang.sh 'stencils/fdtd-apml/fdtd-apml.c' '-O3' '-I utilities -I stencils/fdtd-apml -DPOLYBENCH_TIME -DSMALL_DATASET -DPOLYBENCH_DUMP_ARRAYS -DPOLYBENCH_STACK_ARRAYS' '' 'fdtd-apml_out' 'utilities/polybench.c' '-fixpfracbitsamt=16 -fixpbitsamt=32' 
