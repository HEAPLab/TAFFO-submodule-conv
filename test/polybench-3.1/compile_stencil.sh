...
echo fdtd-2d
./magiclang.sh 'stencils/fdtd-2d/fdtd-2d.c' '-O3' '-I utilities -I stencils/fdtd-2d -DPOLYBENCH_TIME -DSMALL_DATASET -DPOLYBENCH_DUMP_ARRAYS -DPOLYBENCH_STACK_ARRAYS' '' 'fdtd-2d_out' 'utilities/polybench.c' '-fixpfracbitsamt=24 -fixpbitsamt=32' 
