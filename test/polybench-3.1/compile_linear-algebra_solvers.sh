...
echo durbin
./magiclang.sh 'linear-algebra/solvers/durbin/durbin.c' '-O3' '-I utilities -I linear-algebra/solvers/durbin -DPOLYBENCH_TIME -DSTANDARD_DATASET -DPOLYBENCH_DUMP_ARRAYS -DPOLYBENCH_STACK_ARRAYS' '' 'durbin_out' 'utilities/polybench.c' '-fixpfracbitsamt=8 -fixpbitsamt=32' 
...
echo ludcmp
./magiclang.sh 'linear-algebra/solvers/ludcmp/ludcmp.c' '-O3' '-I utilities -I linear-algebra/solvers/ludcmp -DPOLYBENCH_TIME -DSTANDARD_DATASET -DPOLYBENCH_DUMP_ARRAYS -DPOLYBENCH_STACK_ARRAYS' '' 'ludcmp_out' 'utilities/polybench.c' '-fixpfracbitsamt=16 -fixpbitsamt=32'
