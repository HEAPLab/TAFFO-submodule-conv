...
struct FloatToFixed : public llvm::ModulePass {
  ...
  llvm::Function *handleSpecialCase(llvm::CallSite *call, bool *old);
  ...
  createSinCos(llvm::Function *newf, llvm::Function *oldf,
               SmallVector<std::pair<BasicBlock *, SmallVector<Value *, 10>>, 3>
                   &to_change);
  void dispatchFunction(const std::string &disp);
  ...
  /** Returns if a function is a library function which shall be new generated
   *  @param f The function to check */
  bool isHandled(const llvm::Function *f);
